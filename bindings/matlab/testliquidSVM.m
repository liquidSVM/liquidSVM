...
function tests = testliquidSVM
    tests = functiontests(localfunctions);
end

%% Test Functions
function test_mcSVM_AvA_hinge(d)
...
function test_mcSVM_OvA_hinge(d)
...
function setupOnce(d)  % do not change function name
    load data
    I = randperm(4000,400);
...
function teardownOnce(d)  % do not change function name
end
